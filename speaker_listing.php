...
$speakers_design = 1;
if(isset($postmeta['speakers_design'])) {
    $speakers_design = $postmeta['speakers_design'][0];
}
$speaker_array = array();                                                     
...
?>   
<div class="speaker_listing_section wp_conference_container <?php if($speakers_design == 2) { echo 'speaker_list_container_wrapper'; } ?>">
    <div class="container">
...
<!--                <div class="header_list_search">
        ...
        <!--                                    <a data-fancybox data-src="#speaker_<?php echo $speaker_id; ?>" href="javascript:;"><div class="bt_bio">Bio</div></a>
                                        ...
                                        <div class="box_information_lower_part">
                                            ...
                                            <div class="lower_text_part" title="<?php echo $speaker['company_name']; ?>">
                                                <?php 
                                                    if(strlen($speaker['company_name']) > 30) {
                                                        echo substr($speaker['company_name'], 0, 30).'...';
                                                    } else {
                                                        echo $speaker['company_name'];
                                                    }                                                                
                                                ?>
                                            </div>
                                        </div>
            ...
            <?php } else if($speakers_design == 2) { ?>            
                    <!------------------------------------speaker overview new style--------------------------->
                    <div class="speaker_overview_wrapper">
                        <div class="speaker_overview_inner">
                            <?php 
                            if(count($speakers_array) > 0) {
                                   foreach($speakers_array as $speaker_id => $speaker) {
                            ?>                                
                                        <div class="col-xs-3 speaker_blog_wrapper">
                                            <div class="speaker_blog_inner">
                                                ...
                                                <div class="speaker_text">                                                        
                                                    <h4><a href="<?php echo get_permalink($speaker_id); ?>?conf=<?php echo $atts['conferenceid']; ?>"><?php echo $speaker['name']; ?></a></h4>
                                                    <p title="<?php echo $speaker['job_title']; ?>">
                                                        <?php 
                                                            if(strlen($speaker['job_title']) > 70) {
                                                                echo substr($speaker['job_title'], 0, 70).'...';
                                                            } else {
                                                                echo $speaker['job_title'];
                                                            }
                                                        ?>
                                                    </p>
                                                    <b>
                                                        <span title="<?php echo $speaker['company_name']; ?>">
                                                            <?php 
                                                                if(strlen($speaker['company_name']) > 50) {
                                                                    echo substr($speaker['company_name'], 0, 50).'...';
                                                                } else {
                                                                    echo $speaker['company_name'];
                                                                }                                                                
                                                            ?>
                            ...
                            <?php }
                                ...
                                echo '<div class="col-xs-3 speaker_blog_wrapper" style="color: #fff;">No matching result found!</div>';
                            }
                            ?>
                        </div>
                    </div>
